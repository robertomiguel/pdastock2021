  ...
  return (
    <div>
      <Switch>
        ...
        <PrivateRouter exact path="/sales/:id" component={Sales} />
        <PrivateRouter exact path="/stock" component={Stock} />
        <PrivateRouter exact path="/stock/:id" component={Stock} />
        <PrivateRouter exact path="/customer" component={Customer} />
        <PrivateRouter exact path="/customer/:id" component={Customer} />
        <PrivateRouter exact path="/supplier" component={Supplier} />
        <PrivateRouter exact path="/supplier/:id" component={Supplier} />
